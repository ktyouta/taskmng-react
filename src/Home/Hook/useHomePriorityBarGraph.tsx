...
function useHomePriorityBarGraph(props: propsType) {
    ...
    const barTaskList = useMemo(() => {
        ...
        let priotiryObj: barGraphTaskPriorityListType = {
            name: '優先度',
            低: 0,
            中: 0,
            高: 0
...
export default useHomePriorityBarGraph;