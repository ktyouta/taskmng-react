...
import useHomePriorityBarGraph from './Hook/useHomePriorityBarGraph';
...
function HomePriorityBarGraph(props: propsType) {

    console.log("HomePriorityBarGraph render");

    const {
        barTaskList
    } = useHomePriorityBarGraph({ ...props });
...
export default HomePriorityBarGraph;