...
function SideStackBarGraphComponent<T extends listObjType>(props: propsType<T>) {

    console.log("SideStackBarGraphComponent render");
...
export default SideStackBarGraphComponent;